...
public class ManageStudent {
	...
	public void manageCourse() {
		...
		if ("1".equals(select)) {
			...
			System.out.print("input Name of course to delete");
...
//			while(!val.validateCode(studentCode)) {
//				System.out.println("invalidate error!");
//				System.out.print("Student Code: ");
...
//			}
	...
	public void manageSubhect() {
		...
		if ("1".equals(select)) {
			...
			System.out.print("Number Credit: ");
			int numberCredit = sc.nextInt();
			sc.nextLine();
	...
	public void manageTypeOfTrainning() {
		...
		System.out.println("Select 1: to insert a type of trainning" + "\nSelect 2: to delete a type of trainning"
				...
				+ "\nSelect 5: to go to menu");
		System.out.print("please choose(TypeOfTrainning): ");
		String select = sc.nextLine();
		if ("1".equals(select)) {
			System.out.println("input the information of type of trainning to insert");
			System.out.print("Type of Trainning's Code");
			String typeCode = sc.nextLine();
			System.out.print("Type of Trainning's Name: ");
			...
			System.out.println("Type of Trainning's Name");
			String typeName = sc.nextLine();
			...
			System.out.println("Type of Trainning's Code");
			String typeCode = sc.nextLine();
			System.out.println("Type of Trainning's Name: ");
			String typeName = sc.nextLine();
	...
	public void manageClass() {
		...
		if ("1".equals(select)) {
			...
			String deptCode = sc.nextLine();
			System.out.println("Type Of Trainning: ");
			String typeTrain = sc.nextLine();
			System.out.println("Course of Code: ");
			...
			System.out.println("input class Code to remove: ");
			String classCode = sc.nextLine();
			...
			System.out.print("Department Code: ");
			String deptCode = sc.nextLine();
			System.out.print("Type Of Trainning: ");
			String typeTrain = sc.nextLine();
			System.out.print("Course of Code: ");
			String courseCode = sc.nextLine();
