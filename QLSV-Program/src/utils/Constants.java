...
public interface Constants {
    ...
    interface Mark {
        ...
        // update mark
        public static final String UPDATE_STUDENT_BY_ID = "update diem set "
                + SEMESTER + "=?, " + FIRST_MARK + "=?, " + SECOND_MARK
                + "=? where " + STUDENT_ID + "=? and " + SUBJECT_ID + "=?";

        // delete mark
        public static final String DELETE_STUDENT = "delete from student where "
    ...
    interface TypeOfTraining {
        ...
        public static final String UPDATE_TYPE_OF_TRAINING_BY_ID = "update hedt set "
                + TYPE_OF_TRAINING_NAME + "=? where " + TYPE_OF_TRAINING_ID
                + "=?";

        // delete type of training by id
        public static final String DELETE_TYPE_OF_TRAINING_BY_BY_ID = "delete from student where "
                + TYPE_OF_TRAINING_ID + "=?";

        // get type of training by id
        public static final String GET_TYPE_OF_TRAINING_BY_BY_ID = "select * from sinhvien where "
                + TYPE_OF_TRAINING_ID + "=?";
    ...
    interface Student {
        ...
        // update student
        public static final String UPDATE_STUDENT_BY_ID = "update sinhvien set "
                + STUDENT_NAME + "=?, " + GENDER + "=?, " + BIRTH_DAY + "=?, "
                + ADDRESS + "=?, " + CLASS_ID + "=?, where" + STUDENT_ID + "=?";
        ...
        // get student by id
        public static final String GET_STUDENT_BY_ID = "select * from sinhvien where "
                + STUDENT_ID + "=?";
    ...
    interface Course {
        ...
        // update course
        public static final String UPDATE_COURSE_BY_ID = "update khoahoc set "
                + COURSE_NAME + "=? where " + COURSE_ID + "=?";

        // delete course by id
        public static final String DELETE_COURSE_BY_ID = "delete from khoahoc where "
                + COURSE_ID + "=?";

        // get course by id
        public static final String GET_COURSE_BY_ID = "select * from khoahoc where "
                + COURSE_ID + "=?";

        // filter for course
        public static final String COURSE_FILTER = "select * from khoahoc where concat("
                + COURSE_NAME + ", " + COURSE_ID + ") like ";
    }
